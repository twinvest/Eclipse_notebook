		...
		<div id="jb-content">
			...
			<form name="memberForm" method=post action=addMember.jsp>
				...
				<div class="dynamiclabel">
					<input id="ID" placeholder="id" type="text" name=id> <label
						for="ID">ID</label> <input type="button" value="중복체크"
						onClick="checkID()">
				</div>

				<div class="dynamiclabel">
					<input id="email" placeholder="passwd" type="password" name=passwd>
				...
				<div class="dynamiclabel1">
					...
					<label for="jnum">주민등록번호 ※ '-'는 생략하여 입력해주세요.</label>
				</div>
				...
				<div class="dynamiclabel1">
					<input id="anum" placeholder="주소" type="text" name=anum> <label
						for="anum">주소</label>
				</div>

				<div class="dynamiclabel">
					<input type=submit value="가입하기" onClick="checking()"> <input
						type=reset value="재작성">
